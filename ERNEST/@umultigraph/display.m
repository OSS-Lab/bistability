function display(g)
% display Display vertices and edges of an undirected multigraph.
% display(G) displays the vertices and edges of the undirected multigraph
% G.
